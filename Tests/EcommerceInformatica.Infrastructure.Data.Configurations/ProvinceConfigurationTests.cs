...
public class ProvinceConfigurationTests
{
    ...
    [Fact]
    public void Configure_ShouldMapToProvincesTable()
    {
        // Arrange
        var modelBuilder = CreateModelBuilder();
        var configuration = new ProvinceConfiguration();

        // Act
        configuration.Configure(modelBuilder.Entity<Province>());
        var model = modelBuilder.FinalizeModel();
        var entityType = model.FindEntityType(typeof(Province));

        // Assert
        Assert.NotNull(entityType);
        Assert.Equal("Provinces", entityType.GetTableName());
    }
    ...
    [Fact]
    public void Configure_ShouldSetCitiesRelationship()
    {
        // Arrange
        var modelBuilder = CreateModelBuilder();
        var configuration = new ProvinceConfiguration();
        ...
        // Assert
        Assert.NotNull(entityType);
        var navigation = entityType.FindNavigation("Cities");
